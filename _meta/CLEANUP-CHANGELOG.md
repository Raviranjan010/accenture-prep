# CLEANUP-CHANGELOG.md — Repository Restructuring Audit Log
...
- **Renamed**: `cognitive-mcq-classic.md` $\rightarrow$ `classic-cognitive-mcq-fallback.md`
...
- **Moved**: `02-technical-coding/dsa-practice/arrays-strings.md`, `dp-graphs.md` $\rightarrow$ `04-coding-round/dsa-practice/*`
...
### `07-mock-tests/`
- **Moved**: `05-mock-tests/mock-test-1.md` $\rightarrow$ `07-mock-tests/mock-test-1.md`
- **Moved**: `05-mock-tests/mock-test-1-answers.md` $\rightarrow$ `07-mock-tests/mock-test-1-answers.md`
- **Moved**: `05-mock-tests/mock-test-2.md` $\rightarrow$ `07-mock-tests/mock-test-2.md`
- **Moved**: `05-mock-tests/mock-test-2-answers.md` $\rightarrow$ `07-mock-tests/mock-test-2-answers.md`
- **Moved**: `05-mock-tests/mock-test-3.md` $\rightarrow$ `07-mock-tests/mock-test-3.md`
- **Moved**: `05-mock-tests/mock-test-3-answers.md` $\rightarrow$ `07-mock-tests/mock-test-3-answers.md`
- **Moved**: `06-capstone-mock-day.md` (root) $\rightarrow$ `07-mock-tests/capstone-mock-day.md`

### `08-progress-trackers/`
- **Merged**: `01-aptitude/mock-test-logs.md` + `05-mock-tests/score-tracker.md` $\rightarrow$ `08-progress-trackers/aptitude-mock-score-tracker.md`
- **Moved**: `02-technical-coding/dsa-practice/solved-problems-log.md` $\rightarrow$ `08-progress-trackers/dsa-solved-problems-log.md`
- **Moved**: `03-communication/recorded-practice-log.md` $\rightarrow$ `08-progress-trackers/spoken-practice-log.md`
- **Moved**: `04-interview-prep/mock-interview-log.md` $\rightarrow$ `08-progress-trackers/mock-interview-log.md`

### `_meta/`
- **Moved**: `00-MASTER-PROMPT.md` (root) $\rightarrow$ `_meta/00-MASTER-PROMPT.md`
- **Moved**: `AUDIT.md` (root) $\rightarrow$ `_meta/AUDIT.md`
- **Moved**: `CLEANUP-AND-REORG-PLAN.md` (root) $\rightarrow$ `_meta/CLEANUP-AND-REORG-PLAN.md`
- **Moved**: `COVERAGE-CHECKLIST.md` (root) $\rightarrow$ `_meta/COVERAGE-CHECKLIST.md`
- **Moved**: `REQUIREMENTS.md` (root) $\rightarrow$ `_meta/REQUIREMENTS.md`
- **Moved**: `RESOURCE-LINKS.md` (root) $\rightarrow$ `_meta/RESOURCE-LINKS.md`
- **Moved**: `ROADMAP.md` (root) $\rightarrow$ `_meta/ROADMAP.md`
- **Moved**: `TEACHING-STANDARD.md` (root) $\rightarrow$ `_meta/TEACHING-STANDARD.md`
- **Moved**: `TOPICS-TO-COVER.md` (root) $\rightarrow$ `_meta/TOPICS-TO-COVER.md`
- **Moved**: `TRICKS-AND-SHORTCUTS.md` (root) $\rightarrow$ `_meta/TRICKS-AND-SHORTCUTS.md`
...
- **Deleted Root Files**:
  ...
  - `resources.md` (Merged into `ADDITIONAL-RESOURCES.md` and `_meta/RESOURCE-LINKS.md`)
- **Deleted Redundant Tracking / Duplicate Files**:
  - `01-aptitude/mock-test-logs.md` (Merged)
  - `05-mock-tests/score-tracker.md` (Merged)
  - `03-communication/recorded-practice-log.md` (Renamed/moved to `08-progress-trackers/spoken-practice-log.md`)
  - `04-interview-prep/mock-interview-log.md` (Moved to `08-progress-trackers/mock-interview-log.md`)

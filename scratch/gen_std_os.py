...
- **Realistic Calculation Example**:
  ...
  - Execution Sequence: $P_1 (3ms) \rightarrow P_2 (3ms) \rightarrow P_3 (2ms) \rightarrow P_1 (3ms) \rightarrow P_2 (1ms) \rightarrow P_1 (4ms)$.
...
- **Rule**:
  - $q$ too large $\rightarrow$ Degenerates into FCFS.
  - $q$ too small $\rightarrow$ Context switch overhead destroys performance.
...
5. **Answer**: The CPU pauses execution $\rightarrow$ generates hardware interrupt $\rightarrow$ OS fetches required page from Disk into RAM $\rightarrow$ updates Page Table $\rightarrow$ resumes process execution.
6. **Answer**:
